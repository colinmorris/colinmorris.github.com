...
Better yet, we could combine combine this with the idea of adding more depth, and stack convolutional layers, with low-level layers detecting simple character bigrams or trigrams, and higher layers learning words or combinations of words.
